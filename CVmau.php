              ...
              <div class="noidungcv">
                ...
                <div class="nd1">
                  <div class="thongtin">
                    ...
                    <ul class="list_thongtin">
                      <li class="item_thongtin">Giải quyết vấn đề</li>
                      <li class="item_thongtin">Kỹ năng giao tiếp</li>
                      <li class="item_thongtin">Kỹ năng quản lý dự án</li>
                    </ul>
                  </div>
                  <div class="lienhe">
                ...
                <div class="nd1">
                  <div class="kinhnghiem">
                    ...
                    <ul class="list_thongtin">
                      <li style="color:black" class="item_thongtin">06/2016 – 06/2017 Chức danh – Tên công ty</li>
                      <li class="item_thongtin">
                        Thành tựu chính:<br>
                        - Những thành tựu chính bạn đã gặt hái trong công việc này<br>
                        - Nên thể hiện bằng con số, tỷ lệ phần trăm tăng trưởng hoặc số liệu tài chính<br>
                        Các kỹ năng bạn đã đạt được:<br>
