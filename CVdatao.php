...
<?php 
    ...
    if(isset($_SESSION['isLoggin'])){            
      if(isset($_SESSION['idUser'])){
        ...
        $sql1 = "SELECT * FROM `thongtincv` WHERE IDnd ='$id'";
        $query = mysqli_query($conn,$sql);
        $row = mysqli_fetch_array($query);

        $query1 = mysqli_query($conn,$sql1);
        $row1 = mysqli_fetch_array($query1);
        $row11 = mysqli_num_rows($query1);
    ...
    <div class="main">
        <div class="body">
            <div class="cv">
              <div class="noidungcv">
                <div class="gedit">
                    <a class="thea" href="./taocv.php"><i class="fas fa-edit"></i></a>
                </div>
                <div class="topcv">
                  <div class="anhdd">
                    <div class="avatar">
                  ...
                  <div class="thongtin">
                    ...
                    <ul class="list_thongtin">
                      <li class="item_thongtin">
                        ...
                        <?php 
                            if($row11 > 0){
                                $date=date_create($row1['Sinhnhat']);
